...
public class OI {
    ...
    public JoystickButton climbStartButton;
    public JoystickButton climbStopButton;
    ...
    public OI() {
        ...
        climbStopButton = new JoystickButton(manipulatorStick, 4);
        climbStopButton.whenPressed(new Climb());
        climbStartButton = new JoystickButton(manipulatorStick, 2);
        climbStartButton.whenPressed(new Climb());
        pushCrateButton = new JoystickButton(manipulatorStick, 3);
